...
def write_train_summary_helper(train_summary, batch, disps, loss, global_step):
    ...
    write_summary(train_summary, disps[-1][0], 'disp', 'disp', global_step)
    write_summary(train_summary, img_syns[0][-1], 'ref1_syn', 'img', global_step)
    write_summary(train_summary, img_syns[1][-1], 'ref2_syn', 'img', global_step)
